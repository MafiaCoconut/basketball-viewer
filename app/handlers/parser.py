...
class Parser:
    ...
    def start_parser(self):
        ...
        # Преобразование BeautifulSoup объекта в строку и парсинг с помощью lxml
        tree = etree.HTML(str(soup))

        # Поиск элемента с помощью XPath
        button = tree.xpath('//*[@id="EventDetailsAndListingCard"]/div[4]/div[3]/div[3]')[0]

        # Вывод найденного элемента
        print(button.tag, button.text)
